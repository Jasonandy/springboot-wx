...
<body>
	<div id="login">
				...
				<form id="form1" action="${baseURL}/login" method="post">
					...
					<div class="login_user">
						...
						<ul>
							...
							<li>
								<input type="password" name="wanguoPwd" size="18" class="login_input" />
							</li>
						</ul>
					</div>
					<c:if test="${captchaEbabled}">
						<div class="login_code">
							<ul>
								<li>
									<label>${captchaEbabled}验证码：</label>
								</li>
								<li class="input_code">
		...
		<div id="login_footer">
			Copyright &copy; 2018-
			<a href="http://www.wanguo.com" target="_blank">广州万国信息</a>
		</div>
	</div>
